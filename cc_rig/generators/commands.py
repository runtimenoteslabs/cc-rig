...
_COMMAND_DEFS: dict[str, tuple[str, str, str]] = {
    ...
    "remember": (
        ...
        (
            ...
            "   - **Team** (architecture, patterns, gotchas, "
            "ownership): save to `memory/` files below.\n"
            "   - **Personal** (local prefs, machine-specific "
            "notes): save to auto-memory instead.\n"
            "2. Determine the category: decision, pattern, "
            "gotcha, or general.\n"
            ...
            "5. If session-log.md has >20 entries, summarize "
            "older ones.\n"
            "\n"
            "Keep entries concise. One line per learning. "
            "Team memory is git-tracked — everyone sees it."
        ),
    ),
    "refactor": (
