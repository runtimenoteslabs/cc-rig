...
The E2E test matrix (`tests/integration/test_e2e_matrix.py`) provides systematic verification of `cc-rig init` output across all configuration dimensions: 15 templates × 5 workflows × 4 harness levels × 4 feature flags. 21 representative scenarios plus full cross-product validation.
